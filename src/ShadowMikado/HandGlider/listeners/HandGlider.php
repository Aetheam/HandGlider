...
namespace ShadowMikado\HandGlider\listeners;
...
use ShadowMikado\HandGlider\instance\CustomEffectInstance;
    ...
    public function onHeld(PlayerItemHeldEvent $e)
    {
        if ($this->hasHandGliderPermission($e->getPlayer())) {
            if ($this->isHandGlider($e->getItem())) {
                $effect = new CustomEffectInstance(VanillaEffects::LEVITATION(), 20 * 1000000, -4, false);
